...
public:
    ...
    HRESULT StartCaptureAsync(DWORD processId, bool includeProcessTree, PCWSTR outputFileName,wchar_t* outputDevice);
...
private:
    ...
    HRESULT ActivateAudioInterface(DWORD processId, bool includeProcessTree, wchar_t* outputDevice);
    HRESULT FinishCaptureAsync();

    HRESULT SetDeviceStateErrorIfFailed(HRESULT hr);

    wil::com_ptr_nothrow<IAudioClient> m_AudioClient;
    wil::com_ptr_nothrow<IAudioClient> m_AudioClientOut;
    WAVEFORMATEX* m_CaptureFormat{};
    WAVEFORMATEX* m_CaptureFormat2{};
    UINT32 m_BufferFrames = 0;
    UINT32 m_BufferFramesOut = 10000000000;
    wil::com_ptr_nothrow<IAudioCaptureClient> m_AudioCaptureClient;
    wil::com_ptr_nothrow<IAudioRenderClient> m_AudioRenderClient;
    wil::com_ptr_nothrow<IMFAsyncResult> m_SampleReadyAsyncResult;
    wchar_t* outputId = NULL;
